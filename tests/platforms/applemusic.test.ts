...
describe('Apple Music platform tests', () => {
    ...
    const pathTemplates = {
        ...
        playlist: '{locale}/playlist/camila-cabello-apple-music-live/pl.a7f376b0f3af4918a722686f5e5bbc23',
    ...
    describe('URL Detection', () => {
        test('detect basic URLs', () => {
            ...
            expect(mod.detect('https://music.apple.com/us/playlist/camila-cabello-apple-music-live/pl.a7f376b0f3af4918a722686f5e5bbc23')).toBe(true)
            expect(mod.detect('https://music.apple.com/us/song/shake-it-off/1440913819')).toBe(true)
            expect(mod.detect('https://music.apple.com/us/station/apple-music-1/ra.978194965')).toBe(true)
            expect(mod.detect('https://podcasts.apple.com/us/podcast/the-daily/id1200361736')).toBe(true)
            expect(mod.detect('https://embed.podcasts.apple.com/us/podcast/the-daily/id1200361736?i=1000123456789')).toBe(true)
    ...
    describe('Validation and Utils', () => {
        ...
        test('URL normalization', () => {
            const testCases = [
                ...
                {
                    input: 'https://music.apple.com/us/artist/taylor-swift/159260351?utm_source=twitter&fbclid=abc123',
                    expected: 'https://music.apple.com/us/artist/taylor-swift/159260351'
                }
            ]
    ...
    describe('Embed Info', () => {
        test('generate embed URL for music content', () => {
            const testCases = [
                {
                    input: 'https://music.apple.com/us/artist/taylor-swift/159260351',
                ...
                {
                    input: 'https://music.apple.com/us/playlist/camila-cabello-apple-music-live/pl.a7f376b0f3af4918a722686f5e5bbc23',
                    expected: 'https://embed.music.apple.com/us/playlist/camila-cabello-apple-music-live/pl.a7f376b0f3af4918a722686f5e5bbc23?theme=auto'
                },
                {
        ...
        test('generate embed URL for podcast content', () => {
            const testCases = [
                {
                ...
                },
                {
                    ...
                    expected: 'https://embed.podcasts.apple.com/us/podcast/the-daily/id1200361736?i=1000123456789&theme=auto'
                }
            ]
        ...
        test('preserve existing query parameters', () => {
            const input = 'https://music.apple.com/us/artist/taylor-swift/159260351?utm_source=twitter&fbclid=abc123'
            const expected = 'https://embed.music.apple.com/us/artist/taylor-swift/159260351?utm_source=twitter&fbclid=abc123&theme=auto'
