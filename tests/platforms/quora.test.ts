...
describe('Quora platform tests', () => {
    ...
    describe('builders', () => {
        test('profile builder', () => {
            expect(mod.buildProfileUrl?.('Second-User')).toBe('https://www.quora.com/profile/Second-User')
        })
        test('question builder', () => {
            expect(mod.buildContentUrl?.('question', 'Some-Question')).toBe('https://www.quora.com/Some-Question')
        })
        test('answer builder', () => {
